    ...
    <div>
      ...
      <div className={styles.informativa}>
        <p>
          ...
          a continuación se reflejan los siguientes datos: la empresa titular
          del dominio web es SG08 GYM SL (en adelante GO! FITNESS), con
          domicilio a estos efectos en Calle Avda Ámsterdam, 4; Jerez de la
          Frontera, 11405 Cádiz. Correo electrónico de contacto:
          info@gofitness.es, del sitio web. USUARIOS: El acceso y/o uso de este
          portal de GO! FITNESS atribuye la condición de USUARIO, que acepta,
          desde dicho acceso y/o uso, las Condiciones Generales de Uso aquí
          reflejadas. Las citadas Condiciones serán de aplicación
          ...
          grupos de noticias) que SG08 GYM SL ofrece a través de su portal y con
          carácter enunciativo pero no limitativo, a no emplearlos para (i)
          incurrir en actividades ilícitas, ilegales o contrarias a la buena fe
          y al orden público; (ii) difundir contenidos o propaganda de carácter
          ...
          sistemas físicos y lógicos de SG08 GYM SL, de sus proveedores o de
          terceras personas, introducir o difundir en la red virus informáticos
          o cualesquiera otros sistemas físicos o lógicos que sean susceptibles
          de provocar los daños anteriormente mencionados; (iv) intentar acceder
          y, en su caso, utilizar las cuentas de correo electrónico de otros
          usuarios y modificar o manipular sus mensajes. SG08 GYM SL se reserva
          el derecho de retirar todos aquellos comentarios y aportaciones que
          vulneren el respeto a la dignidad de la persona, que sean
          discriminatorios, xenófobos, racistas, pornográficos, que atenten
          ...
          cualquier caso, SG08 GYM SL no será responsable de las opiniones
          vertidas por los usuarios a través de los foros, chats, u otras
          herramientas de participación. PROTECCIÓN DE DATOS: SG08 GYM SL cumple
          con las directrices de la Ley Orgánica 15/1999 de 13 de diciembre de
          Protección de Datos de Carácter Personal, el Real Decreto 1720/2007 de
          21 de diciembre por el que se aprueba el Reglamento de desarrollo de
          la Ley Orgánica y demás normativa vigente en cada momento, y vela por
          garantizar un correcto uso y tratamiento de los datos personales del
          usuario. Para ello, junto a cada formulario de recabo de datos de
          carácter personal, en los servicios que el usuario pueda solicitar a
          SG08 GYM SL, hará saber al usuario de la existencia y aceptación de
          las condiciones particulares del tratamiento de sus datos en cada
          ...
          Asimismo, SG08 GYM SL informa que da cumplimiento a la Ley 34/2002 de
          ...
          de su correo electrónico con fines comerciales en cada momento. Esta
          información se encuentra más extensamente contenida en la
          pestaña/enlace “Política de Privacidad”, de esta misma página web.
          PROPIEDAD INTELECTUAL E INDUSTRIAL: SG08 GYM SL por sí o como
          cesionaria, es titular de todos los derechos de propiedad intelectual
          e industrial de su página web, así como de los elementos contenidos en
          la misma (a título enunciativo, imágenes, sonido, audio, vídeo,
          ...
          titularidad de SG08 GYM SL o bien de sus licenciantes. Todos los
          derechos reservados. En virtud de lo dispuesto en los artículos 8 y
          32.1, párrafo segundo, de la Ley de Propiedad Intelectual, quedan
          ...
          sin la autorización de SG08 GYM SL. El USUARIO se compromete a
          respetar los derechos de Propiedad Intelectual e Industrial
          titularidad de SG08 GYM SL. Podrá visualizar los elementos del portal
          e incluso imprimirlos, copiarlos y almacenarlos en el disco duro de su
          ...
          instalado en el las páginas de SG08 GYM SL. EXCLUSIÓN DE GARANTÍAS Y
          RESPONSABILIDAD: SG08 GYM SL, no se hace responsable, en ningún caso,
          ...
          evitarlo. MODIFICACIONES: SG08 GYM SL se reserva el derecho de
          ...
          que éstos aparezcan presentados o localizados en su portal. ENLACES:
          En el caso de que en nombre del dominio se dispusiesen enlaces o
          hipervínculos hacía otros sitios de Internet, SG08 GYM SL no ejercerá
          ningún tipo de control sobre dichos sitios y contenidos. En ningún
          caso SG08 GYM SL asumirá responsabilidad alguna por los contenidos de
          ...
          participación con las entidades conectadas. DERECHO DE EXCLUSIÓN: SG08
          GYM SL se reserva el derecho a denegar o retirar el acceso a portal
          ...
          presentes Condiciones Generales de Uso. GENERALIDADES: SG08 GYM SL
          perseguirá el incumplimiento de las presentes condiciones así como
          cualquier utilización indebida de su portal ejerciendo todas las
          acciones civiles y penales que le puedan corresponder en derecho.
          MODIFICACIÓN DE LAS PRESENTES CONDICIONES Y DURACIÓN: SG08 GYM SL
          podrá modificar en cualquier momento las condiciones aquí
          ...
          publicadas. LEGISLACIÓN APLICABLE Y JURISDICCIÓN: La relación entre
          SG08 GYM SL y el USUARIO se regirá por la normativa española vigente y
          cualquier controversia se someterá a los Juzgados y tribunales de la
