    ...
    <div>
      ...
      <div className={styles.informativa}>
        <p>
          ...
          De conformidad con lo establecido por la Ley Orgánica 15/1999, de 13
          de diciembre, de Protección de Datos de Carácter Personal (en
          adelante, LOPD), el Real Decreto 1720/2007, de 21 de diciembre, por el
          que se aprueba el Reglamento de desarrollo de la Ley Orgánica 15/1999,
          de 13 de diciembre, de protección de datos de carácter personal y el
          ...
          usuario, así como el posterior envío de comunicaciones comerciales de
          la empresa referente a sus servicios. 3. Carácter obligatorio o
          facultativo de la información facilitada por el usuario y veracidad de
          los datos. Los campos señalados en el formulario de registro a
          ...
          de las finalidades para las que se solicitan sus datos personales.
          Para la recepción de sus correos y garantizar el consentimiento del
          tratamiento de sus datos de carácter personal, para la emisión de
          correos a través de nuestro enlace “Contacto”, se ha previsto que,
          necesariamente, deba clicar en la casilla de verificación de su
          conformidad. Para casos distintos, la empresa les remitirá un
          formulario de consentimiento en la primera comunicación en la que nos
          dirijamos a Usted. 5. Derechos de los usuarios. De acuerdo con Ley
          Orgánica 15/1999, de 13 de diciembre, de Protección de Datos de
          Carácter Personal (en adelante, LOPD), el Real Decreto 1720/2007, de
          21 de diciembre, por el que se aprueba el Reglamento de desarrollo de
          la Ley Orgánica 15/1999, de 13 de diciembre, de protección de datos de
          carácter personal y el REGLAMENTO (UE) 2016/679 DEL PARLAMENTO EUROPEO
          ...
          de datos personales y a la libre circulación de estos datos así como a
          las normas nacionales actualmente en vigor, y ha establecido todos los
          ...
          tratamiento seguro en las cesiones, que en su caso, puedan producirse.
          7. Información sobre cookies y técnicas de “spamming” El usuario
          consiente el uso de cookies, que en ningún caso permitirán su
          identificación, con la exclusiva finalidad de facilitar su navegación
          ...
          controversia relativas a nuestra política de privacidad y de
          protección de datos personales el usuario puede ponerse en contacto
          con nosotros. El tratamiento de los datos de carácter personal, así
          como el envío de comunicaciones comerciales realizadas por medios
          electrónicos, son conformes a la Ley Orgánica 15/1999, de 13 de
          diciembre, de Protección de Datos de Carácter Personal (B.O.E. de 14
