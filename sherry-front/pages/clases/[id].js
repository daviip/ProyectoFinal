...
let img = [Walking, Ciclo, ForTraining, BodyCombat, Pilates, Yoga, CrossTraining, BodyPump, Zumba];
let index = ["Walking", "Ciclo", "For Training", "Body Combat", "Pilates", "Yoga", "Cross Training", "Body Pump", "Zumba"];
            ...
            <div>
                ...
                <div>
                    ...
                    <div className={styles.porClases}>
                        <Image src={ img[i] } width={ 300 } height={ 300 } className={styles.porClases1}/>
